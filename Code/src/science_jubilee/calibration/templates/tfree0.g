...
G53 G0 X37.0 Y150.0 F12000    ; Rapid to the back of the post. Stay away from the tool rack so we don't collide with tools.
...
G53 G1 Y337.0 F6000            ; Controlled move to the park position with tool-1. (park_x, park_y)
